...
if(isset($_POST['buttonthemsach'])) {
    ...
    $sql = "INSERT INTO sach(id_sach,ten_sach,mo_ta,ngay_xuat_ban,so_trang,ma_sach,id_kichthuoc,id_tac_gia,id_dichgia,
          id_loai_sach,id_nha_cung_cap,id_loaibia,id_nxb)
          VALUES ('$idsach','$tensach','$mota','$ngayxb','$sotrang','$sodangky','$kt','$tg','$dg','$ls',
                  '$nhacungcap','$loaibs','$nhaxb')";
      ...
      <div class="modal-body">
        ...
        <form method="POST" enctype="multipart/form-data" action="">
          ...
          <table>
            ...
            <td><input class="td-input-short" type="text" name="id-sach"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="text-align: right;padding: 20px 5px 10px 5px;">
                ...
                <input class="td-input-button" style="background-color: green;" type="submit" name="buttonthemsach" value="Thêm sách">
                  <button>ok</button>
              </td>
            </tr>
          </table>
