...
<body>
	...
	<!-- Include Modal -->
		...
		<div class="container">		
		<h5> Danh sách những tác giả hiện có trong hệ thống: </h5>
		<form method="POST">
			<button type="button" class="buttonthem" data-toggle="modal" data-target="#modal-them-tac-gia">Thêm Tác Giả</button>
				    ...
				    <?php 
				    	...
				    	if($result){
				    		...
				    		while ($row=$result->fetch_assoc()) {
				    			echo "<tr>";
				    			echo "<td>".$stt."</td>";
				    			echo "<td>".$row['id_tac_gia']."</td>";
				    			echo '<td style="text-align:left;">'.$row['ten_tac_gia'].'</td>';
