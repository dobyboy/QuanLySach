        ...
        <div class="row">
            ...
            if ($num > 0){
                ...
                <div class="col-lg-7">
                    ...
                    }?><label style="font-size: 10px; color: #8A888B; font-weight: normal;">(1 đánh giá - 1 bình luận)</label></p>
            ...
            if ($dong['so_luong_sach'] == 0){?>
                ...
                <?php }else{ ?>
                <button type="submit" class="btn btn-info btn-lg" name="muahang"
                        onclick="window.location.href='allitem.php?xemchitetsp&id=<?php echo $dong_loai['id_loai_sach'] ?>&idsp=<?php echo $dong['id_sach'] ?>&show=1';">
                    <i class="glyphicon glyphicon-shopping-cart"></i>Mua hàng
                </button>
                <?php } ?>
                </div>
...
<script>
    function thongbao() {
        alert("Hiện tại sản phẩm đã hết hàng");
    }
</script>
