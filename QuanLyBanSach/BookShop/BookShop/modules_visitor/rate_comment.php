...
//}
if (isset($_POST['post'])){
    echo '<script> window.location.href= "../main_visitor/payment.php?xhitietsp&idsp='.$_GET['idsp'].'"</script>';
    }
//
//
//
                ...
                <div class="col-lg-10">
                    <div id="panel-cmt" class="panel panel-default">
                        ...
                        <form class="panel-body" action="" method="post">
                            ...
                            <button id="post"  name="post">Đăng</button>
                        </form><!-- /panel-body -->
            ...
            <div class="review-block">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <img src="../main_customer/15078737_694047914097563_8971106796230046362_n.jpg" style="width: 50px; height: 50px;" class="img-rounded">
