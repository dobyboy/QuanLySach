...
ORDER BY k.so_luong_sach ASC LIMIT 8";
    ...
    <div class="col-lg-3" xmlns="http://www.w3.org/1999/html" style="margin-top: 20px">
        ...
        <div class="card h-100">
            <div class="box" style="min-height: 150px!important;">
                <div class="ribbon red"><span class="red">Hot</span>
                </div>
                <a class="img" href="item.php?xem=chitietsp&id=<?php echo $dong_sp['id_loai_sach'] ?>&idsp=<?php echo $dong_sp['id_sach'] ?>">
                    <center>
            ...
            <div class="card-body" style="min-height: 50px;">
                <h4 class="card-title">
                    <a href="item.php?xem=chitietsp&id=<?php echo $dong_sp['id_loai_sach'] ?>&idsp=<?php echo $dong_sp['id_sach'] ?>"><?php echo $dong_sp['ten_sach'] ?></a>
                </h4>
